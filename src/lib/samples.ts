...
export const opStandardBridges: readonly OpStandardBridge[] = [
  {
    chainId: 10,
...
export const transactionSamples: readonly TransactionSample[] = [
  ...
  {
    id: "optimism-op-standard-bridge-legacy-erc20-withdrawal",
    group: "bridges",
    label: "OP Stack legacy ERC-20 withdrawal request",
    summary: "Confirmed Optimism → Ethereum Standard Bridge request, block 156,451,153. It shows the submitted L2 token and amount, recipient, minimum gas, and opaque identification data; the L1 token mapping and finalization are not inferred.",
    source: "confirmed EVM",
    transaction: {
      chainId: 10,
      from: "0x0926ef19fb9c6c8e31eeaeb92ed01aadfd605baa",
